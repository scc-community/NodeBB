...
var invitationController = module.exports;

invitationController.get = function (req, res, callback) {
	...
	async.waterfall([
		...
		function (results, next) {
			...
			userData.breadcrumbs = helpers.buildBreadcrumbs([{ text: userData.username, url: '/user/' + userData.userslug }, { text: '[[user:invite-link]]' }]);
