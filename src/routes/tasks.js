...
module.exports = function (app, middleware, controllers) {
	...
	setupPageRoute(app, '/task/mytask/detail', middleware, middlewares, controllers.tasks.center.getDetail);
	...
	setupPageRoute(app, '/task/project/downloadcmp', middleware, middlewares, controllers.tasks.project.downloadCodeModulePackage);
